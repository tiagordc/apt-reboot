...
func New(ip, email, password string) *SmartPlug {
	h := sha1.New()
	h.Write([]byte(email))
...
func (d *SmartPlug) GetURL() string {
	if d.token == nil {
...
func (d *SmartPlug) DoRequest(payload []byte) ([]byte, error) {
...
func (d *SmartPlug) CheckErrorCode(errorCode int) error {
	if errorCode != 0 {
...
func (d *SmartPlug) Handshake() (err error) {
...
func (d *SmartPlug) Login() (err error) {
	if d.cipher == nil {
...
func (d *SmartPlug) Switch(status bool) (err error) {
	if d.token == nil {
...
func (d *SmartPlug) GetDeviceInfo() (*SmartPlugInfo, error) {
	if d.token == nil {
